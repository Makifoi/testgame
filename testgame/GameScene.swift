...
//  testgame
//
//  Created by Yudi Makino on 2019/05/30.
//  Copyright © 2019 Yudi Makino. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
	...
	func addAsteroid() {
		...
		asteroid.physicsBody?.collisionBitMask = missileCategory + spaceshipCategory + earthCategory
